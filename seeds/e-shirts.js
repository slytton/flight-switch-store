...
exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    knex('shirts').insert({design_id: 2, color_id: 3, size_id: 3, quantity: 2, price:25, shirt_image_url_id: 2}),
    knex('shirts').insert({design_id: 2, color_id: 3, size_id: 2, quantity: 1, price:25, shirt_image_url_id: 2}),
    knex('shirts').insert({design_id: 2, color_id: 3, size_id: 1, quantity: 6, price:25, shirt_image_url_id: 2}),
